...
public class AddTokoApdActivity extends AppCompatActivity {
    ...
    EditText titleEt;
    EditText descriptionEt, locationEt, priceEt, numberEt;
    ImageView imageIv;
    Button uploadBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_toko_apd);

        actionBar = getSupportActionBar();
        assert actionBar != null;
        actionBar.setTitle(R.string.tambah_apd_baru);
        ...
        uploadBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(title)){
                    Toast.makeText(AddTokoApdActivity.this, R.string.masukkan_judul, Toast.LENGTH_SHORT).show();
                    return;
                }

                if(TextUtils.isEmpty(desc)) {
                    Toast.makeText(AddTokoApdActivity.this, R.string.masukkan_deskripsi, Toast.LENGTH_SHORT).show();
                    return;
                }

                if(TextUtils.isEmpty(location) || TextUtils.isEmpty(price) || TextUtils.isEmpty(number)) {
                    Toast.makeText(AddTokoApdActivity.this, R.string.not_empty, Toast.LENGTH_SHORT).show();
                    return;
                }
    ...
    private void uploadData(final String title, final String desc, String uri) {
        ...
        String fileNameAndPath = "Toko_APD/" + "barang" + timeStamp;
                    ...
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            if(uriTask.isSuccessful()) {
                                ...
                                hashMap.put("pPrice", priceEt.getText().toString().trim());
                                ...
                                DatabaseReference ref = FirebaseDatabase.getInstance().getReference("Toko");
                                ...
                                ref.child(timeStamp).setValue(hashMap)
                                        .addOnSuccessListener(new OnSuccessListener<Void>() {
                                            ...
                                            public void onSuccess(Void aVoid) {
                                                showLoader(false);
                                                Toast.makeText(AddTokoApdActivity.this, R.string.post_published, Toast.LENGTH_SHORT).show();
                                                //reset views
                                                titleEt.setText("");
                                        ...
                                        .addOnFailureListener(new OnFailureListener() {
                                            ...
                                            public void onFailure(@NonNull Exception e) {
                                                showLoader(false);
                                                Toast.makeText(AddTokoApdActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            }
